...
VistA is built on the **M database** supported by **Intersystems IRIS** and hosted on the federally-certified **Amazon Web Services** cloud (see: https://cloudvista.github.io).
