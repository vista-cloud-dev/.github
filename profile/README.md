...
VistA is built on the **M application database** technology provided by **Intersystems IRIS** and is hosted on the federally-certified **Amazon Web Services** cloud (see: https://cloudvista.github.io).
