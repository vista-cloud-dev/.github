...
VA VistA is built on the **M application database** running on **Intersystems IRIS**, the identical M-based platform and technology that all Epic healthcare systems use worldwide. Beyond the same core technology as Epic, all VistA systems have been migrated and consolidated to the industry-leading cloud platform provided by **Amazon Web Services**, enabling the next generation of cloud-based AI-driven healthcare innovation and services. For information on the VistA Health Cloud see https://cloudvista.github.io.
